...
export function createLiquid(elements, options = {}) {
  ...
  return {
    ...
    setOptions(next) {
      ...
      const resolutionChanged = simResolution !== config.simResolution || dyeResolution !== config.dyeResolution;
...
export function Liquid({
  ...
  // React 17 port: useSyncExternalStore(emptySubscribe, supportsHtmlInCanvas,
  //   () => false) requires React 18+; this one-time support probe is equivalent.
