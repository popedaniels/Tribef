...
exports.approvedFundingRequestMailService = async (user, request, campaign) => {
  ...
  let mailOptions = {
    ...
    <tr>
    <td align="left" class="es-m-txt-c" style="padding:0;Margin:0"><h2 style="Margin:0;line-height:29px;mso-line-height-rule:exactly;font-family:'open sans', 'helvetica neue', helvetica, arial, sans-serif;font-size:24px;font-style:normal;font-weight:bold;color:#212121;text-align:center"><strong>${
      campaign.organizer
    } has just made a funding request of ${getCurrency(request.currency)}${
      request.amount
    } from the “${
    ...
    } alt style="display:block;border:0;outline:none;object-fit: cover;text-decoration:none;-ms-interpolation-mode:bicubic" width="200" height="192"></td>
    </tr>
    </table></td>
    </tr>
    </table>
  ...
  try {
    ...
    logger.info("Approved funding request mail sent");
  } catch (err) {
    logger.error({ err }, "Approved funding request mail failed");
    throw err;
  }
};
