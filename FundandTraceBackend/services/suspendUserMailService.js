...
exports.suspendUserMailService = async (profile, message) => {
...
Hi, ${profile.firstName} ${profile.lastName}. <br />
    Your account has been suspended after finding out somethings about it. <br/>
  ...
  try {
    ...
    logger.info("Suspend user mail sent");
  } catch (err) {
    logger.error({ err }, "Suspend user mail failed");
    throw err;
  }
};
