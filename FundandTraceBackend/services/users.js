...
exports.mailService = async (email, token) => {
...
<body style="background-color: #FAFAFA">
                            ...
                            <td align="center" style="font-size:0px;padding:10px 15px;word-break:break-word;">
                              <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="border-collapse:collapse;border-spacing:0px;">
                                <tbody>
                                  <tr>
                                    <td style="width:60px;">
                                      <img height="auto" src="https://res.cloudinary.com/wisdomosara/image/upload/v1620243876/logo_a50tjp.png" style="border:0;display:block;outline:none;text-decoration:none;height:auto;width:100%;font-size:13px;" width="60" />
                                    </td>
                                  </tr>
                                </tbody>
                              </table>
                            ...
                            <td vertical-align="top" style="font-size:0px;padding-top:40px;padding-bottom:40px;word-break:break-word;">
                              <div class="mj-column-per-100 mj-outlook-group-fix" style="font-size:0px;text-align:left;direction:ltr;display:inline-block;vertical-align:top;width:100%;">
                                <table border="0" cellpadding="0" cellspacing="0" role="presentation" width="100%">
                                  <tbody>
                                    <tr>
                                      <td style="background-color:white;border-radius:8px;vertical-align:top;padding-top:40px;padding-bottom:40px;">
                                        <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="" width="100%">
                                          <tr>
                                          ...
                                          <tr>
                                            <td align="center" style="font-size:0px;padding:10px 15px;word-break:break-word;">
                                              <div style="font-family:Rubik, Helvetica, Arial, sans-serif;font-size:13px;font-weight:normal;line-height:1;text-align:center;color:#514949;">In order to start using your Fund&Trace account, you need to confirm your email address.</div>
                                            </td>
                                          </tr>
                                          <tr>
  ...
  try {
    ...
    logger.info("User verification mail sent");
  } catch (error) {
    logger.error({ err: error }, "User verification mail failed");
    throw error;
  }
};
